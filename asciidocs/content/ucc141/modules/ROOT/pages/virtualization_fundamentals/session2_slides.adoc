...
| **Installation**
| Boot from ISO (Replaces OS)
| Install like an App (`.exe` / `.deb`)
...
. **Feature Rich:** Snapshots, seamless mode, shared folders.
